          ...
          <div className="contenido-secundario">
            ...
            <div className="servicio-destacado-con-imagen">
              ...
              <div className="contenido-servicio">
                ...
                <p>Gestión de relacionamiento estratégico, distribución de comunicados de prensa y coordinación de eventos.</p>
                <button className="boton-minimalista">Pide una contratación</button>
              </div>
            </div>
          </div>
        </div>
